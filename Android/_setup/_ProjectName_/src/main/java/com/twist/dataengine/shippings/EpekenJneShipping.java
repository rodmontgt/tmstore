...
public class EpekenJneShipping extends ShippingEngine {
    private String key = "";
    private String androidKey = "";
    private String id = "";
    private TM_Region superCountry;

    public EpekenJneShipping(String baseURL, String key) {
        request_url_countries = baseURL + "/wp-tm-ext-store-notify/api/epeken_jne_list_of_province/";
        request_url_states = baseURL + "/wp-tm-ext-store-notify/api/epeken_jne_list_of_kecamatan/";
        request_url_sub_discricts = baseURL + "/wp-tm-ext-store-notify/api/epeken_jne_list_of_province/";
        request_url_cities = baseURL + "/wp-tm-ext-store-notify/api/epeken_jne_list_of_kota_kabupaten/";
        request_url_calculate_shipping = "http://pro.rajaongkir.com/api/cost";
        request_url_find_shippings = baseURL + "/wp-tm-ext-store-notify/api/epken_jne_shipping_cost/";
    ...
    public void getStates(final TM_Region parent, final DataQueryHandler dataQueryHandler) {
        ...
        NetworkRequest.makeCommonPostRequest(request_url_cities, params, null, postResponseListener);
    ...
    private List<TM_Region> parseJsonAndCreateSubDistricts(TM_Region parent, String jsonStringContent) {
        ...
        try {
            jMainObject = DataHelper.safeJsonObject(jsonStringContent);
            String province = jMainObject.getString("province");
