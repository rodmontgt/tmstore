...
@interface ConektaCardPaymentVC(){
...
@implementation ConektaCardPaymentVC
...
- (void)pay {
    ...
    [params setObject:base64_str(config.infoOrderItems) forKey:@"order_items"];
    [params setObject:base64_str(config.infoBillingAddress) forKey:@"billing_address"];
    [params setObject:base64_str(config.infoShippingAddress) forKey:@"shipping_address"];
    [params setObject:base64_str(config.infoShipment) forKey:@"shipment"];
