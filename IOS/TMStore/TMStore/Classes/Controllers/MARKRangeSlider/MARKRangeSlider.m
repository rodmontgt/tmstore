...
- (void)setUpViewComponents
{
    ...
    self.rangeImageView.image = [_rangeImageView.image imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
    [self.rangeImageView setTintColor:[Utility getUIColor:kUIColorBlue]];
    ...
    self.leftThumbImageView.image = [_leftThumbImageView.image imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
    [self.leftThumbImageView setTintColor:[Utility getUIColor:kUIColorBlue]];
    ...
    self.rightThumbImageView.image = [_rightThumbImageView.image imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
    [self.rightThumbImageView setTintColor:[Utility getUIColor:kUIColorBlue]];
...
-(void)setimagecolor:(UIColor*)trackImageViewColor rangeImageView:(UIColor*)rangeImageView leftThumbImageView:(UIColor*)leftThumbImageView rightThumbImageView:(UIColor*)rightThumbImageView{
    [self.trackImageView setTintColor:trackImageViewColor];
    [self.rangeImageView setTintColor:rangeImageView];
    [self.leftThumbImageView setTintColor:leftThumbImageView];
    [self.rightThumbImageView setTintColor:rightThumbImageView];
}
