...
typedef enum : NSUInteger {
    CategoryViewLayoutType_P0_C0,
    CategoryViewLayoutType_P1_C0,
    CategoryViewLayoutType_P0_C1,
    CategoryViewLayoutType_P1_C1,
} CategoryViewLayoutType;
...
@interface ViewControllerCategories : UIViewController <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout , UIScrollViewDelegate, CHTCollectionViewDelegateWaterfallLayout,UITabBarDelegate> {
...
@property CategoryViewLayoutType cViewLayoutType;
