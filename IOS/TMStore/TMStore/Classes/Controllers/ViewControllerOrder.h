...
@interface ViewControllerOrder: UIViewController <UIAlertViewDelegate, UIScrollViewDelegate, UITextViewDelegate> {
...
@property UITextView* trackAlertTextView;
@property UIAlertView* trackAlertView;
@end
