...
-(CGFloat)tableView:(UITableView*)tableView heightForHeaderInSection:(NSInteger)section
{
    ...
    {
        UIView *headerView = [self.delegate PTEHorizontalTableView:self viewForHeaderInSection:section];
...
-(CGFloat)tableView:(UITableView *)tableView heightForFooterInSection:(NSInteger)section
{
    ...
    {
        UIView *footerView = [self.delegate PTEHorizontalTableView:self viewForFooterInSection:section];
...
-(UIView*)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    if ([self.delegate respondsToSelector:@selector(tableView:viewForHeaderInSection:)])
    {
		UIView *sectionView = [self.delegate PTEHorizontalTableView:self viewForHeaderInSection:section];
...
-(UIView*)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section
{
    if ([self.delegate respondsToSelector:@selector(tableView:viewForFooterInSection:)])
    {
		UIView *sectionView = [self.delegate PTEHorizontalTableView:self viewForFooterInSection:section];
		return [self viewToHoldSectionView:sectionView];
    }
    return nil;
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        [self.delegate PTEHorizontalTableView:self didSelectRowAtIndexPath:indexPath];
    }
}
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        return [self.delegate PTEHorizontalTableView:self widthForCellAtIndexPath:indexPath];
    }
...
-(NSInteger)numberOfSectionsInTableView:(UITableView *)tableView
{
    ...
    {
        return [self.delegate numberOfSectionsInPTEHorizontalTableView:self];
    }
    return 1;
}
...
{
	return [self.delegate PTEHorizontalTableView:self numberOfRowsInSection:section];
}

- (UITableViewCell *)tableView:(UITableView *)aTableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    UITableViewCell * cell = [self.delegate PTEHorizontalTableView:self cellForRowAtIndexPath:indexPath];
