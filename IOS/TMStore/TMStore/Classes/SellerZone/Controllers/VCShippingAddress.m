...
@implementation VCShippingAddress

- (void)viewDidLoad {

    [super viewDidLoad];
    [[UINavigationBar appearance] setTitleTextAttributes: [NSDictionary dictionaryWithObjectsAndKeys: [Utility getUIColor:kUIColorThemeFont], NSForegroundColorAttributeName, [Utility getUIFont:kUIFontType24 isBold:false], NSFontAttributeName, nil]];
    [self.currentItemHeading setTitle:@"Shipping Address"];
...
- (void)viewWillAppear:(BOOL)animated{
    ...
    [_labelFirstName setText:[NSString stringWithFormat:@"%@",oInfo._shipping_address._first_name]];
    [_labelLastName setText:[NSString stringWithFormat:@"%@",oInfo._shipping_address._last_name]];
    [_labelCompanyName setText:[NSString stringWithFormat:@"%@",oInfo._shipping_address._company]];
    [_labelAddress1 setText:[NSString stringWithFormat:@"%@",oInfo._shipping_address._address_1]];
    [_labelAddress2 setText:[NSString stringWithFormat:@"%@",oInfo._shipping_address._address_2]];
    [_labelCity setText:[NSString stringWithFormat:@"%@",oInfo._shipping_address._city]];
    [_labelState setText:[NSString stringWithFormat:@"%@",oInfo._shipping_address._state]];
    [_labelPostCode setText:[NSString stringWithFormat:@"%@",oInfo._shipping_address._postcode]];
    [_labelCountry setText:[NSString stringWithFormat:@"%@",oInfo._shipping_address._country]];
