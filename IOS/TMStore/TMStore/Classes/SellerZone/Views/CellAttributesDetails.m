...
@implementation CellAttributesDetails

- (void)awakeFromNib {
    [super awakeFromNib];
    // Initialization code
    [_buttonCheckMark setImage:[[UIImage imageNamed:@"managing_icon_selected.png"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate] forState:UIControlStateSelected];
