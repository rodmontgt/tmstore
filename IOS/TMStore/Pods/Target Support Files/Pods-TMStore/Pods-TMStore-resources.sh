...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_resource "FreshchatSDK/FreshchatSDK/FCResources.bundle"
  install_resource "FreshchatSDK/FreshchatSDK/FreshchatModels.bundle"
  install_resource "FreshchatSDK/FreshchatSDK/FCLocalization.bundle"
